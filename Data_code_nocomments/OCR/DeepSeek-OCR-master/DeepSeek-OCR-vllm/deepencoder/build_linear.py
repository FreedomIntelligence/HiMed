...
class MlpProjector(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        if cfg.projector_type == 'identity':
            ...
            modules = [nn.LayerNorm(cfg.input_dim * cfg.downsample_ratio * cfg.downsample_ratio), nn.Linear(cfg.input_dim * cfg.downsample_ratio * cfg.downsample_ratio, cfg.n_embed * mlp_ratio)]
