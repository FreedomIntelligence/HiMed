...
def main():
    parser = argparse.ArgumentParser(
        description="Clean JSON files by removing 'type' field, cleaning text, and adding metadata"
    )
    parser.add_argument(
        "--input-dir",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to output directory for cleaned JSON files"
    )
    parser.add_argument(
        "--force-overwrite",
        action="store_true",
    ...
    parser.add_argument(
        ...
        type=str,
        default=".json",
        help="File suffix to filter (default: .json)"
    )
