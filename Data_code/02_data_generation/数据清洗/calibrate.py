...
def call_gpt_with_images(text: str, image_paths: List[Path]) -> str:
    ...
    if len(content) == 1:
        return text
    messages = [{'role': 'system', 'content': 'You are a highly accurate OCR post-correction assistant.'}, {'role': 'user', 'content': content}]
